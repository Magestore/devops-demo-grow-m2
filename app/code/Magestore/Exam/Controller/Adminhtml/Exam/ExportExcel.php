 ...
 * Action ExportExcel
 */
class ExportExcel extends \Magestore\Exam\Controller\Adminhtml\Exam
{
    /**
     * Execute action
     */
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Magestore\Exam\Block\Adminhtml\Exam\Grid')->getExcel();
