<?php
namespace Magestore\Webpos\Model\WebPosSession;

/**
 * Interceptor class for @see \Magestore\Webpos\Model\WebPosSession
 */
class Interceptor extends \Magestore\Webpos\Model\WebPosSession implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\Request\Http $request, \Magento\Framework\Session\SidResolverInterface $sidResolver, \Magento\Framework\Session\Config\ConfigInterface $sessionConfig, \Magento\Framework\Session\SaveHandlerInterface $saveHandler, \Magento\Framework\Session\ValidatorInterface $validator, \Magento\Framework\Session\StorageInterface $storage, \Magento\Framework\Stdlib\CookieManagerInterface $cookieManager, \Magento\Framework\Stdlib\Cookie\CookieMetadataFactory $cookieMetadataFactory, \Magento\Framework\App\State $appState, \Magento\Framework\Url\Helper\Data $coreUrl, \Magento\Framework\UrlFactory $urlFactory, \Magento\Framework\Session\Generic $session, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\App\Http\Context $httpContext, \Magento\Customer\Api\GroupManagementInterface $groupManagement, \Magento\Framework\App\Response\Http $response, \Magestore\Webpos\Model\Staff\StaffFactory $posUserFactory, \Magento\Store\Model\StoreManagerInterface $storeManager)
    {
        $this->___init();
        parent::__construct($request, $sidResolver, $sessionConfig, $saveHandler, $validator, $storage, $cookieManager, $cookieMetadataFactory, $appState, $coreUrl, $urlFactory, $session, $eventManager, $httpContext, $groupManagement, $response, $posUserFactory, $storeManager);
    }
    ...
    public function setUserId($id)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setUserId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWebPosUserAsLoggedIn');
        if (!$pluginInfo) {
            return parent::setWebPosUserAsLoggedIn($user);
        } else {
            return $this->___callPlugins('setWebPosUserAsLoggedIn', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function loginById($webPosId)
    {
        ...
        if (!$pluginInfo) {
            return parent::loginById($webPosId);
        } else {
